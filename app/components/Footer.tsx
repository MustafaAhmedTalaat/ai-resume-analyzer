export default function Footer() {
    ...
    return (
        <footer className="w-full bg-slate-900 text-slate-200 mt-auto">
            <div className="max-w-5xl mx-auto px-4 md:px-5 py-6 md:py-8">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-6">
                    <div>
                        <h3 className="text-base md:text-lg font-semibold">Resumind</h3>
                        <p className="text-xs md:text-sm text-slate-400">AI resume feedback to help you get interviews.</p>
                    </div>
